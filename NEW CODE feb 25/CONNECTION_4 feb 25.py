    ...
    def change_price(self):
        ...
        if(False):
            ...
            try:
                ...
                cursor.execute(sql, (rice.get(), onekg.get(), halfkg.get(), twokg.get()))
                con.commit()
